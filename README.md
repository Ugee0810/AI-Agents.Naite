...
| `output/今後何がしたいか(향후목표).yaml`| 향후에 무엇을 하고 싶은지 (입사 후 포부 / 목표) | 공통    |
| `output/転職軸(전직축).yaml`     | 전직축 — 전직에서 가장 중시하는 판단 기준 (転職軸) | ★최종만 |
| `output/逆質問(역질문).yaml`     | 역질문 목록 3개 + 의도 해설 (현장/役員 2버전)   | 공통    |
